...
namespace Syncfusion.PresentationDemos.WinUI
{
    public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
			...
			DemoInfo markdownToPPTX = new()
            {
                Name = "Markdown To PPTX",
                Category = "Conversions",
                DemoType = DemoTypes.New,
                Description = "This example demonstrates how to convert Markdown file to PowerPoint presentation(PPTX) file.",
                DemoView = typeof(EssentialPresentation.MarkdownToPPTX),
                ShowInfoPanel = true
            };
            selectionDocumentations = new List<Documentation>
            {
                new Documentation() { Content = "PowerPoint library - MarkdownToPPTX", Uri = new Uri("https://help.syncfusion.com/document-processing/powerpoint/conversions/markdown-to-powerpoint") }
            };
            markdownToPPTX.Documentation.AddRange(selectionDocumentations);
			
			DemoInfo pptxToMarkdown = new()
            {
                Name = "PPTX To Markdown",
                Category = "Conversions",
                DemoType = DemoTypes.New,
                Description = "This example demonstrates how to convert PowerPoint presentation(PPTX) file to Markdown file.",
                DemoView = typeof(EssentialPresentation.PPTXToMarkdown),
                ShowInfoPanel = true
            };
            selectionDocumentations = new List<Documentation>
            {
                new Documentation() { Content = "PowerPoint library - PPTXToMarkdown", Uri = new Uri("https://help.syncfusion.com/document-processing/powerpoint/conversions/powerpoint-to-markdown") }
            };
            pptxToMarkdown.Documentation.AddRange(selectionDocumentations);
