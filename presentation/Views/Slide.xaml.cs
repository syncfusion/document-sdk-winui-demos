...
namespace EssentialPresentation
{
    ...
    /// </summary>
    public sealed partial class Slide : Page
    {
        #region Constructor
        /// <summary>
        ...
        private void BtnCreatePresn_Click(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            ...
            string resourcePath = path + "Assets.Presentation.Slides.pptx";
            ...
            if (presentationdoc.IsChecked == true)
            {
                ...
                SaveAndLaunch.Save("Slide.pptx", stream);
            }
            else
            {
                ...
                //Saves the memory stream as file.
                SaveAndLaunch.Save("Slide.pdf", stream);
            }
        }
        #endregion
        ...
        private static void CreateThirdSlide(IPresentation presentation)
        {
            ...
            Assembly assembly = typeof(Slide).GetTypeInfo().Assembly;
            string resourcePath = path + "Assets.Presentation.tablet.jpg";
