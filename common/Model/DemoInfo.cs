    ...
    public class DemoInfo : ITileInfo
    {
        ...
        public string Badge
        {
            get
            {
                ...
                else if ((this.DemoType & DemoTypes.AISamples) == DemoTypes.AISamples)
                {
                    if (this.DemoType.HasFlag(DemoTypes.New))
                    {
                        return Constants.New;
        ...
        /// <summary>
        /// Gets or sets a value of sub demo page which holds the sample.
        /// </summary>
        public List<DemoInfo> SubCategoryDemos { get; set; }        
    }

    /// <summary>
    /// Represents documentation information for a demo or control.
    /// This class typically holds details like the documentation link, description, and related resource links (GitHub, features).
    /// </summary>
