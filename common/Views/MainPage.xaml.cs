...
{
    /// <summary>
    /// Represents the main page of the application, serving as the primary window content.
    /// It hosts the navigation pane (<see cref="NavigationView"/>), the main content frame (<see cref="MainFrame"/>),
    /// and manages the application's ViewModel (<see cref="MainViewModel"/>), including its initialization and AI settings integration.
    /// </summary>
    public sealed partial class MainPage : Page
    {
        /// <summary>
        /// Gets the NavigationView control instance used for navigation.
        /// </summary>
        ...
        /// Registers the Syncfusion license, initializes the UI components, sets up the navigation service and ViewModel,
        /// validates AI credentials, and sets the initial theme.
        /// </summary>
        public MainPage()
        {
