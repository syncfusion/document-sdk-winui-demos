...
namespace Syncfusion.DemosCommon.WinUI
{
    ...
    public sealed partial class SettingsPage : Page
    {
        ...
        /// </summary>
        public string WinUISamplesLink => UIStringsProvider.WinUISamplesLink;
        /// <summary>
        /// Gets the link to the API documentation from UIStringsProvider.
        /// </summary>
        public string WinUIApiDocsLink => UIStringsProvider.WinUIApiDocsLink;
        /// <summary>
        /// Gets the link to the User Guide from UIStringsProvider.
        /// </summary>
        public string WinUIUserGuideLink => UIStringsProvider.WinUIUserGuideLink;
        /// <summary> 
        /// Gets the link to the Syncfusion WinUI feedback page from UIStringsProvider. 
        /// </summary>
        public string WinUIFeedbackLink => UIStringsProvider.WinUIFeedbackLink;
        /// <summary> 
        /// Gets the link to the Syncfusion WinUI forums page from UIStringsProvider
        /// </summary>
        public string WinUIForumLink => UIStringsProvider.WinUIForumLink;
        /// <summary>
