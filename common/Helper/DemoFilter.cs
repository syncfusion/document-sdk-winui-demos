...
{
    /// <summary>
    /// Represents a filter behavior for the SfAutoComplete control, enabling fuzzy search capabilities.
    /// It implements the <see cref="IAutoCompleteFilterBehavior"/> interface to provide custom filtering logic.
    /// </summary>
    public class DemoFilter : IAutoCompleteFilterBehavior
    {
        /// <summary>
        /// Gets the matching items asynchronously based on the filter text.
        /// This method combines results from a direct search and a fuzzy search.
        /// </summary>
        /// <param name="source">The SfAutoComplete control that initiated the filter.</param>
        /// <param name="filterInfo">Information about the filter text and other parameters.</param>
        /// <returns>A task that represents the asynchronous operation. The result is an object containing the list of matching items.</returns>
        ...
        /// </summary>
        /// <param name="searchWord">The first string (e.g., the user's input).</param>
        /// <param name="actualWord">The second string (e.g., an item from the list).</param>
