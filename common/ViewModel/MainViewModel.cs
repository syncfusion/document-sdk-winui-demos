...
namespace Syncfusion.DemosCommon.WinUI
{
    ...
    public class MainViewModel : NotificationObject
    {
        ...
        /// <summary>
        /// Gets or sets the selected item within a sub-category or secondary selection list.
        /// Fires `OnSubDemoSelectedItemChanged` when changed.
        /// </summary>
        ...
        /// <summary>
        /// Handles the selection of a tile or a navigation item.
        /// It updates the VM's state, navigates to appropriate pages, and manages UI element visibility.
        /// </summary>
        ...
        private void OnThemeSelection()
        {
            ...
            {
                var demoLayouts = SubCategorySelectedItem != null && SubCategorySelectedItem is DemoInfo demoInfo ?
                                  LogicalTree.FindChildren<DemoLayout>(frameworkElement) : VisualTree.FindDescendants<DemoLayout>(frameworkElement);
                if (demoLayouts != null)
                {
