...
namespace Markdown
{
    ...
    /// </summary>
    public sealed partial class CreateMarkdown : Page
    {
        #region Fields
        readonly Assembly assembly = typeof(CreateMarkdown).GetTypeInfo().Assembly;
        #endregion
        ...
        #region Events
        /// <summary>
        /// Creates a simple Markdown document with various elements such as headings, text, images, lists, tables, hyperlinks, and code blocks.
        /// </summary>
        private void Button_Click(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            ...
            string filename = "CreateMarkdown.md";
            ms.Position = 0;
