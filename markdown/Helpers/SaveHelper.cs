...
namespace Syncfusion.MarkdownDemos.WinUI.Helpers
{
    /// <summary>
        ...
        public static async void SaveAndLaunch(string filename, MemoryStream stream)
        {
            ...
            if (!Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons"))
            {
                ...
                else if (extension == ".xml")
                {
                    ...
                    savePicker.SuggestedFileName = filename;
                    //Saves the file as WordML file.
                    savePicker.FileTypeChoices.Add("WordML", new List<string>() { ".xml" });
                }
