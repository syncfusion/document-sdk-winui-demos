   ...
   public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            ...
            DemoInfo encryption = new DemoInfo()
            {
                ...
                Category = "Security",
                DemoType = DemoTypes.None,
                Description = "This demo shows how to encrypt the existing PDF document with encryption standards like 40-bit RC4, 128-bit RC4, 128-bit AES, 256-bit AES, advanced encryption standard 256-bit AES Revision 6 (PDF 2.0) and 256-bit AES-GCM (PDF 2.0) to protect documents against unauthorized access.",
            ...
            DemoInfo redaction = new DemoInfo()
            {
                Name = "Redaction",
                Category = "Security",
                DemoType = DemoTypes.None,
            ...
            pdfDocumentations = new List<Documentation>();            
            pdfDocumentations.Add(new Documentation() { Content = "PDF - Working with PDF Redaction", Uri = new Uri("https://help.syncfusion.com/file-formats/pdf/working-with-redaction") });
            redaction.Documentation.AddRange(pdfDocumentations);
            ...
            DemoInfo imageToPdf = new DemoInfo()
            {
                Name = "Image To PDF",
                Category = "Conversions",
                DemoType = DemoTypes.None,
                Description = "This demo shows how to convert the images to PDF document.",
                DemoView = typeof(ImageToPdf),
                ShowInfoPanel = true
            };
            ...
            pdfDocumentations.Add(new Documentation() { Content = "PDF - Working with Images", Uri = new Uri("https://help.syncfusion.com/file-formats/pdf/working-with-images") });
            pdfDocumentations.Add(new Documentation() { Content = "PDF - Inserting an image in an existing PDF document", Uri = new Uri("https://help.syncfusion.com/file-formats/pdf/working-with-images#inserting-an-image-in-an-existing-document") });
            imageToPdf.Documentation.AddRange(pdfDocumentations);

            DemoInfo tiffToPdf = new DemoInfo()
            {
                Name = "TIFF To PDF",
                Category = "Conversions",
                DemoType = DemoTypes.None,
                Description = "This demo shows how to convert single or multi frame TIFF images to PDF.",
                DemoView = typeof(TiffToPdf),
                ShowInfoPanel = true
            };

            pdfDocumentations = new List<Documentation>();
            pdfDocumentations.Add(new Documentation() { Content = "PDF - Working with Images", Uri = new Uri("https://help.syncfusion.com/file-formats/pdf/working-with-images") });
            pdfDocumentations.Add(new Documentation() { Content = "PDF - Converting multi page TIFF to PDF", Uri = new Uri("https://help.syncfusion.com/file-formats/pdf/working-with-images#converting-multi-page-tiff-to-pdf") });
            tiffToPdf.Documentation.AddRange(pdfDocumentations);

            DemoInfo xpsToPdf = new DemoInfo()
            {
                Name = "XPS To PDF",
                Category = "Conversions",
                DemoType = DemoTypes.None,
                Description = "This demo shows how to convert the XPS to PDF document.",
                DemoView = typeof(XpsToPdf),
                ShowInfoPanel = true
            };
            pdfDocumentations = new List<Documentation>();
            pdfDocumentations.Add(new Documentation() { Content = "PDF - Converting XPS document to PDF", Uri = new Uri("https://help.syncfusion.com/file-formats/pdf/converting-xps-to-pdf") });
            xpsToPdf.Documentation.AddRange(pdfDocumentations);
