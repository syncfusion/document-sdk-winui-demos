...
namespace Syncfusion.PdfDemos.WinUI
{
    public sealed partial class Invoice : Page
    {
        ...
        private void GeneratePDF_Click(object sender, RoutedEventArgs e)
        {
            ...
            Stream fontStream = typeof(Invoice).GetTypeInfo().Assembly.GetManifestResourceStream(path + "Assets.NotoSans-Regular.ttf");
            ...
            Stream imageStream = typeof(Invoice).GetTypeInfo().Assembly.GetManifestResourceStream(path + "Assets.AdventureWork.png");
