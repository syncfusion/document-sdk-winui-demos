...
namespace DocIO
{
    ...
    {
        #region Fields
        readonly Assembly assembly = typeof(HelloWorld).GetTypeInfo().Assembly;
        #endregion
        ...
        private void CreateParagraph(WSection section)
        {
            ...
            //Gets the image.
            string resourcePath = path + "Assets.DocIO.HeaderImage.png";
        ...
        private void CreateProductOverviewTable(WSection section)
        {
            ...
            paragraph.BreakCharacterFormat.FontSize = 12f;
            string resourcePath = path + "Assets.DocIO.Mountain200.jpg";
            ...
            paragraph.ApplyStyle("Heading 1");
            paragraph.ParagraphFormat.LineSpacing = 12f;
            resourcePath = path + "Assets.DocIO.Mountain300.jpg";
            //Appends picture to the paragraph.
            ...
            paragraph.ApplyStyle("Heading 1");
            paragraph.ParagraphFormat.LineSpacing = 12f;
            resourcePath = path + "Assets.DocIO.Road550W.jpg";
            //Appends picture to the paragraph.
            imageStream = assembly.GetManifestResourceStream(resourcePath);
            picture = paragraph.AppendPicture(imageStream) as WPicture;
            picture.TextWrappingStyle = TextWrappingStyle.TopAndBottom;
