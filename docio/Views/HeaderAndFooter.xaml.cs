...
namespace DocIO
{
    ...
    public sealed partial class HeaderAndFooter : Page
    {
        ...
        private void Button_Click(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            ...
            string resourcePath = path + "Assets.DocIO.HeaderFooterTemplate.docx";
        ...
        private void InsertFirstPageHeaderFooter(WordDocument doc, IWSection section)
        {
            ...
            Stream imageStream = assembly.GetManifestResourceStream(path + "Assets.DocIO.Northwindlogo.png");
