...
namespace DocIO
{
    ...
    /// </summary>
    public sealed partial class CreateInk : Page
    {
        #region Fields
        readonly Assembly assembly = typeof(CreateInk).GetTypeInfo().Assembly;
        #endregion
        ...
        private void Button_Click(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            ...
            string resourcePath = path + "Assets.DocIO.CreateInkInput.docx";
        ...
        private void ButtonView_Click(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            ...
            ms.Position = 0;
            //Saves the memory stream as file.
            SaveHelper.SaveAndLaunch("CreateInkInput.docx", ms);
        }
        /// <summary>
