...
namespace DocIO
{
    ...
    /// </summary>
    public sealed partial class CreateSmartArt : Page
    {
        #region Fields
        readonly Assembly assembly = typeof(CreateSmartArt).GetTypeInfo().Assembly;
        #endregion
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            string resourcePath = path + "Assets.DocIO.CreateSmartArtInput.docx";
            ...
            switch (comboBox.SelectedIndex)
            {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    // Create a Picture SmartArt diagram and pass Path to load images.
                    CreatePictureSmartArt(document, path);
        ...
        private void CreateRelationshipSmartArt(WordDocument document)
        {
            ...
            // Retrieves the first paragraphand and add text.
            IWParagraph paragraph = section.Paragraphs[0];
            paragraph.ParagraphFormat.HorizontalAlignment = Syncfusion.DocIO.DLS.HorizontalAlignment.Center;
        ...
        /// </summary>
        /// <param name="document">The Word document where the SmartArt diagram will be added.</param>
        /// <param name="resourcePath">The path to the resource folder containing images.</param>
        private void CreatePictureSmartArt(WordDocument document, string resourcePath)
        {
            IWSection section = document.Sections[0];
            ...
            AddPicture(employeeNode1, resourcePath + "Assets.DocIO.Nancy Davolio.png");
            ...
            AddPicture(employeeNode2, resourcePath + "Assets.DocIO.Andrew Fuller.png");
            ...
            AddPicture(employeeNode3, resourcePath + "Assets.DocIO.Janet Leverling.png");
        }
        ...
        private void AddPicture(IOfficeSmartArtNode node, string imagePath)
        {
            ...
            using Stream pictureStream = assembly.GetManifestResourceStream(imagePath);
