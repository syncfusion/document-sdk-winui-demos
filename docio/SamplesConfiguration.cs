...
namespace Syncfusion.DocIODemos.WinUI
{
    public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            ...
            DemoInfo createInk = new()
            {
                Name = "Create Ink",
                Category = "Ink",
                DemoType = DemoTypes.New,
                Description = "This sample demonstrates how to create a Word document with Ink using the .NET Word Library (DocIO).",
                DemoView = typeof(CreateInk),
                ShowInfoPanel = true
            };
            selectionDocumentations = new List<Documentation>
            {
                new Documentation() { Content = "Word library - Working with Ink", Uri = new Uri("https://help.syncfusion.com/document-processing/word/word-library/net/working-with-ink") }
            };
            createInk.Documentation.AddRange(selectionDocumentations);

            DemoInfo editInk = new()
            {
                Name = "Edit Ink",
                Category = "Ink",
                DemoType = DemoTypes.New,
                Description = "This sample demonstrates how to modify Ink in a Word document using the .NET Word Library (DocIO).",
                DemoView = typeof(EditInk),
                ShowInfoPanel = true
            };
            selectionDocumentations = new List<Documentation>
            {
            ...
            editInk.Documentation.AddRange(selectionDocumentations);
