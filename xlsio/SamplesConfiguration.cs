    ...
    public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            ...
            attendancetrackerdemo.Documentation.AddRange(new List<Documentation>()
			 ...
			 DemoInfo autofilldemo = new DemoInfo()
			 {
				 Name = "Auto Fill & Fill Series",
				 Category = "Data Management",
				 Description = "This example demonstrates how Auto fill feature works using XlsIO.",
				 DemoType = DemoTypes.None,
				 DemoView = typeof(Views.AutoFill),
				 ShowInfoPanel = true
			 };
			 autofilldemo.Documentation.AddRange(new List<Documentation>()
				 { new Documentation() { Content = "Excel library - Create a Auto Fill", Uri = new Uri("https://help.syncfusion.com/document-processing/excel/excel-library/net/worksheet/auto-fill"), } });
            ...
            DemoInfo slicerdemo = new DemoInfo()
            {
                Name = "Slicer",
                Category = "Data Management",
                Description = "This example demonstrates how to add slicers in Excel worksheet.",
                DemoType = DemoTypes.None,
                DemoView = typeof(Views.Slicer),
                ShowInfoPanel = true
            };
            slicerdemo.Documentation.AddRange(new List<Documentation>()
            ...
            DemoInfo whatifanalysisdemo = new DemoInfo()
            {
                Name = "What-If Analysis",
                Category = "Data Management",
                Description = "The sample shows how to create different scenarios of What-If Analysis.",
                DemoType = DemoTypes.None,
                DemoView = typeof(Views.WhatIfAnalysis),
                ShowInfoPanel = true
            };
            whatifanalysisdemo.Documentation.AddRange(new List<Documentation>()
                { new Documentation() { Content = "Excel library - What-If Analysis", Uri = new Uri("https://help.syncfusion.com/document-processing/excel/excel-library/net/what-if-analysis"), } });
            ...
            DemoInfo exceltopdfuademo = new DemoInfo()
            {
                Name = "Excel To PDF/UA",
                Category = "Conversions",
                Description = "This example demonstrates how to convert an Excel workbook to PDF/UA along with its charts, shapes, cell styles, etc.",
                DemoType = DemoTypes.None,
                DemoView = typeof(Views.ExcelToPDFUA),
                ShowInfoPanel = true
            };
            exceltopdfuademo.Documentation.AddRange(new List<Documentation>()
                { new Documentation() { Content = "Excel library - Excel to PDF Conversion", Uri = new Uri("https://help.syncfusion.com/file-formats/xlsio/excel-to-pdf-conversion"), } });
			...
			DemoInfo pivottabledemo = new DemoInfo()
            {
                Name = "Pivot Table",
                Category = "Business Intelligence",
                Description = "This example demonstrates how to create pivot table in an Excel worksheet along with grouping.",
                DemoType = DemoTypes.None,
                DemoView = typeof(Views.PivotTable),
                ShowInfoPanel = true
            };
            pivottabledemo.Documentation.AddRange(new List<Documentation>()
                { new Documentation() { Content = "Excel library - Working with Excel Pivot Table", Uri = new Uri("https://help.syncfusion.com/file-formats/xlsio/working-with-pivot-tables"), } });
            
            DemoInfo pivottablelayoutdemo = new DemoInfo()
            {
                Name = "Pivot Table Layout",
                Category = "Business Intelligence",
                Description = "This example demonstrates how to layout pivot table using XlsIO.",
                DemoView = typeof(Views.PivotTableLayout),
                ShowInfoPanel = true
            };
            pivottablelayoutdemo.Documentation.AddRange(new List<Documentation>()
                { new Documentation() { Content = "Excel library - Working with Excel Pivot Table Layout", Uri = new Uri("https://help.syncfusion.com/file-formats/xlsio/working-with-pivot-tables"), } });
            ...
            DemoInfo commentsdemo = new DemoInfo()
            {
                Name = "Comments",
                Category = "Shapes",
                Description = "This example demonstrates how to add notes and comments in an Excel worksheet.",
                DemoType = DemoTypes.None,
                DemoView = typeof(Views.Comments),
                ShowInfoPanel = true
            };
            commentsdemo.Documentation.AddRange(new List<Documentation>()
                { new Documentation() { Content = "Excel library - Comments", Uri = new Uri("https://help.syncfusion.com/document-processing/excel/excel-library/net/working-with-drawing-objects#comments"), } });
            ...
            DemoInfo exceltomarkdowndemo = new DemoInfo()
            {
                Name = "Excel To Markdown",
                Category = "Conversions",
                Description = "This example demonstrates how to convert a Excel to Markdown format.",
                DemoType = DemoTypes.New,
                DemoView = typeof(Views.ExcelToMarkdown),
                ShowInfoPanel = true
            };
            exceltomarkdowndemo.Documentation.AddRange(new List<Documentation>()
                { new Documentation() { Content = "Excel library - Excel to Markdown Conversion", Uri = new Uri("https://help.syncfusion.com/file-formats/xlsio/overview"), } });

            DemoInfo markdowntoexceldemo = new DemoInfo()
            {
                Name = "Markdown To Excel",
                Category = "Conversions",
                Description = "This example demonstrates how to convert a Markdown file to Excel format.",
                DemoType = DemoTypes.New,
                DemoView = typeof(Views.MarkdownToExcel),
                ShowInfoPanel = true
            };
            markdowntoexceldemo.Documentation.AddRange(new List<Documentation>()
                { new Documentation() { Content = "Excel library - Markdown to Excel Conversion", Uri = new Uri("https://help.syncfusion.com/file-formats/xlsio/overview"), } });
